...
def test_pizza_four_cheese() -> None:
    ...
    assert len(pizza_four_cheese.ingredients) == 4
...
def test_change_price_per_ingredient() -> None:
    ...
    assert pizza_napolitana.price() == 10.5
    assert pizza_four_cheese.price() == 14.0
